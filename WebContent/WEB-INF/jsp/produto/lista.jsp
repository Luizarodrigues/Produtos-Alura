...
<body>
		...
		<tr>
         ...
         <c:forEach var="p" items="${produtoList}">
            <tr id="produto${p.id}">
                ...
                <td>${p.descricao}</td>
                <td>
                <fmt:formatDate value="${p.dataInicioVenda.time }" dateStyle="long" />
	...
	<c:url value="/produto/formulario" var="urlNovoProduto" />
<a href="${urlNovoProduto}"><fmt:message key="mensagem.novoproduto"/> </a>
